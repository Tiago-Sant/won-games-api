        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              ...
              <P>Ao lado você pode inserir diferentes jogos publishers para a nossa maravilhosa loja de jogo!</P>
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              ...
              <P style={{ marginTop: 7, marginBottom: 0 }}>Em caso de dúvidas ou sugestões, só ir em algum dos nossos links! =)</P>
              <ALink
